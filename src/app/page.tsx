        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
          {Object.entries(leagues).map(([slug, league], i) => (
            <ScrollReveal key={slug} delay={i * 80}>
              <Link
                href={`/league/${slug}`}
                className="league-card group rounded-xl p-6 border text-left block h-full bg-[#e8e8e8] border-gray-300 hover:border-[var(--red-main)]/30"
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  <span className="hidden lg:inline text-xs rounded-full px-3 py-1 bg-gray-100 text-gray-500">
                ...
                {league.country && (
                  <p className="text-sm mt-0.5 flex items-center gap-1 lg:hidden text-gray-700">
