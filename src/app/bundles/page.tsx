    ...
    <>
            ...
            <div className="relative w-full flex flex-col items-center justify-center">
              <div className="flex items-center justify-center gap-6 lg:gap-12">
                <div className="hidden lg:flex flex-col items-center gap-1.5">
                  <svg className="w-11 h-11 text-gray-500" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 013 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 00-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 01-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 003 15h-.75M15 10.5a3 3 0 11-6 0 3 3 0 016 0zm3 0h.008v.008H18V10.5zm-12 0h.008v.008H6V10.5z" /></svg>
                  <span className="text-[10px] text-gray-500 uppercase tracking-wider">Sparen</span>
                </div>
                <div className="hidden lg:flex flex-col items-center gap-1.5">
                  <svg className="w-11 h-11 text-gray-500" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 10V5.5a1.5 1.5 0 00-3 0L8 14v6h11.5a2 2 0 002-1.7l1.1-7.3a2 2 0 00-2-2.3h-7.1zM8 14H5v6h3" /></svg>
                  <span className="text-[10px] text-gray-500 uppercase tracking-wider">Empfohlen</span>
                </div>
                <div className="text-center">
                  <h3 className="text-3xl lg:text-6xl font-bold uppercase tracking-wide text-gray-900" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>Jetzt profitieren</h3>
                  {/* Mobile icons row */}
                  <div className="flex lg:hidden justify-center gap-6 mt-2">
                    <div className="flex flex-col items-center gap-1">
                      <svg className="w-8 h-8 text-gray-500" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 013 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 00-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 01-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 003 15h-.75M15 10.5a3 3 0 11-6 0 3 3 0 016 0zm3 0h.008v.008H18V10.5zm-12 0h.008v.008H6V10.5z" /></svg>
                      <span className="text-[9px] text-gray-500 uppercase tracking-wider">Sparen</span>
                    </div>
                    <div className="flex flex-col items-center gap-1">
                      <svg className="w-8 h-8 text-gray-500" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 10V5.5a1.5 1.5 0 00-3 0L8 14v6h11.5a2 2 0 002-1.7l1.1-7.3a2 2 0 00-2-2.3h-7.1zM8 14H5v6h3" /></svg>
                      <span className="text-[9px] text-gray-500 uppercase tracking-wider">Empfohlen</span>
                    </div>
                    <div className="flex flex-col items-center gap-1">
                      <svg className="w-8 h-8 text-gray-500" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24"><circle cx="8.25" cy="8.25" r="2.25" /><circle cx="15.75" cy="15.75" r="2.25" /><path strokeLinecap="round" strokeLinejoin="round" d="M19.5 4.5L4.5 19.5" /></svg>
                      <span className="text-[9px] text-gray-500 uppercase tracking-wider">Rabatt</span>
                    </div>
                    <div className="flex flex-col items-center gap-1">
                      ...
                      <span className="text-[9px] text-gray-500 uppercase tracking-wider">Geschenk</span>
                    </div>
                  </div>
                  <p className="text-gray-500 text-xs lg:text-sm mt-2">Profitiere mit Freunden, Familie oder deinem Team — legt eure Trikots zusammen und spart gemeinsam bis zu 30%.</p>
                </div>
                <div className="hidden lg:flex flex-col items-center gap-1.5">
                  <svg className="w-11 h-11 text-gray-500" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24"><circle cx="8.25" cy="8.25" r="2.25" /><circle cx="15.75" cy="15.75" r="2.25" /><path strokeLinecap="round" strokeLinejoin="round" d="M19.5 4.5L4.5 19.5" /></svg>
                  <span className="text-[10px] text-gray-500 uppercase tracking-wider">Rabatt</span>
                </div>
                <div className="hidden lg:flex flex-col items-center gap-1.5">
                  <svg className="w-11 h-11 text-gray-500" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M21 11.25v8.25a1.5 1.5 0 01-1.5 1.5H5.25a1.5 1.5 0 01-1.5-1.5v-8.25M12 4.875A2.625 2.625 0 109.375 7.5H12m0-2.625V7.5m0-2.625A2.625 2.625 0 1114.625 7.5H12m0 0V21m-8.625-9.75h18c.621 0 1.125-.504 1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125h-18c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125z" /></svg>
                  <span className="text-[10px] text-gray-500 uppercase tracking-wider">Geschenk</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="max-w-[1920px] mx-auto px-4 md:px-8 xl:px-12 2xl:px-16 pt-8 pb-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6">
            {/* 3+ Trikots = 15% */}
            <div className={`relative bg-[#e8e8e8] rounded-2xl border-2 overflow-hidden flex flex-col ${activeBundle === '3plus' ? 'border-green-400/50' : 'border-gray-400'}`}>
              {activeBundle === '3plus' ? (
              ...
              <div className="relative bg-gradient-to-br from-[#a8b0b8] to-[#a8b0b8]/40 px-6 py-5 pt-10">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-black text-[var(--red-main)]">15% Rabatt</p>
                  </div>
              ...
              <div className="flex p-4 lg:p-5 pt-2 lg:pt-3 flex-1 flex-col">
                <div className="grid grid-cols-2 auto-rows-[3rem] gap-x-4 mb-5">
                  <div className="flex items-start gap-2 pt-1">
                    <svg className="w-4 h-4 text-[#a8b0b8] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg>
                    <span className="text-sm text-gray-600">15% auf jedes Trikot</span>
                  </div>
                  <div className="flex items-start gap-2 pt-1">
                    <svg className="w-4 h-4 text-[#a8b0b8] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg>
                ...
                <div className="bg-gray-100 rounded-lg px-3 py-3 text-sm text-gray-500 mb-4">
                  3× à CHF 49.90 = <span className="text-[#a8b0b8] font-bold text-lg">CHF 125.–</span> <span className="text-gray-500 line-through ml-1">149.70</span>
                </div>
                <button
            ...
            {/* 6+ Trikots = 20% */}
            <div className={`relative bg-[#e8e8e8] rounded-2xl border-2 overflow-hidden flex flex-col ${activeBundle === '6plus' ? 'border-green-400/50' : 'border-gray-400'}`}>
              {activeBundle === '6plus' ? (
                <div className="absolute top-0 left-0 right-0 bg-green-500 text-white text-center text-xs font-bold py-1.5 uppercase tracking-widest z-10">
                  Aktiv
                </div>
              ) : (
                <div className="absolute top-0 left-0 right-0 bg-[#3a3020] text-[var(--gold)] text-center text-xs font-bold py-1.5 uppercase tracking-widest z-10">
                  Bestes Preis-Leistungs-Verhältnis
                </div>
              )}
              <div className="relative bg-gradient-to-br from-[var(--gold)] to-[var(--gold)]/40 px-6 py-5 pt-10">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-black text-[var(--red-main)]">20% Rabatt</p>
                  </div>
              ...
              <div className="flex p-4 lg:p-5 pt-2 lg:pt-3 flex-1 flex-col">
                <div className="grid grid-cols-2 auto-rows-[3rem] gap-x-4 mb-5">
                  <div className="flex items-start gap-2 pt-1">
                    <svg className="w-4 h-4 text-[var(--gold)] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg>
                    <span className="text-sm text-gray-600">20% auf jedes Trikot</span>
                  </div>
                  <div className="flex items-start gap-2 pt-1">
                    <svg className="w-4 h-4 text-[var(--gold)] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg>
                    <span className="text-sm text-gray-600">Ideal für Mannschaften</span>
                  </div>
                  <div className="flex items-start gap-2 pt-1">
                    <svg className="w-4 h-4 text-[var(--gold)] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg>
                    <span className="text-sm text-gray-600">Rabatt automatisch berechnet</span>
                ...
                <div className="bg-gray-100 rounded-lg px-3 py-3 text-sm text-gray-500 mb-4">
                  6× à CHF 49.90 = <span className="text-[var(--gold)] font-bold text-lg">CHF 240.–</span> <span className="text-gray-500 line-through ml-1">299.40</span>
                </div>
                <button
            ...
            {/* 10+ Trikots = 25% */}
            <div className={`relative bg-[#e8e8e8] rounded-2xl border-2 overflow-hidden flex flex-col ${activeBundle === '10plus' ? 'border-green-400/50' : 'border-gray-400'}`}>
              {activeBundle === '10plus' ? (
                <div className="absolute top-0 left-0 right-0 bg-green-500 text-white text-center text-xs font-bold py-1.5 uppercase tracking-widest z-10">
                  Aktiv
                </div>
              ...
              <div className="relative bg-gradient-to-br from-[#b066c4] to-[#b066c4]/40 px-6 py-5 pt-10">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-black text-[var(--red-main)]">30% Rabatt</p>
                  </div>
              ...
              <div className="flex p-4 lg:p-5 pt-2 lg:pt-3 flex-1 flex-col">
                <div className="grid grid-cols-2 auto-rows-[3rem] gap-x-4 mb-5">
                  <div className="flex items-start gap-2 pt-1">
                    <svg className="w-4 h-4 text-[#b066c4] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg>
                    <span className="text-sm text-gray-600">30% auf jedes Trikot</span>
                  </div>
                  <div className="flex items-start gap-2 pt-1">
                    <svg className="w-4 h-4 text-[#b066c4] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg>
                    <span className="text-sm text-gray-600">Perfekt für Vereine & Teams</span>
                  </div>
                  <div className="flex items-start gap-2 pt-1">
                    <svg className="w-4 h-4 text-[#b066c4] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg>
                    <span className="text-sm text-gray-600">Rabatt automatisch berechnet</span>
                ...
                <div className="bg-gray-100 rounded-lg px-3 py-3 text-sm text-gray-500 mb-4">
                  10× à CHF 49.90 = <span className="text-[#b066c4] font-bold text-lg">CHF 350.–</span> <span className="text-gray-500 line-through ml-1">499.–</span>
                </div>
                <button
          ...
          <div className="flex flex-col items-center">
            <div className="relative w-full flex flex-col items-center justify-center">
              <div className="flex items-center justify-center gap-4 lg:gap-6">
                <svg className="w-20 h-20 text-gray-500 flex-shrink-0" viewBox="0 0 100 100" fill="currentColor">
                  {/* Grosses Zahnrad */}
                ...
                <div>
                  <h3 className="text-3xl lg:text-6xl font-bold uppercase tracking-wide text-gray-900" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>Wie funktioniert&apos;s?</h3>
                  <p className="text-gray-500 text-xs lg:text-sm">Schwierigkeiten? Hier findest du die Anleitung für deine Bundle-Bestellung.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {scrollHint && (
        <div className="fixed bottom-0 left-0 right-0 z-40 pointer-events-none lg:hidden">
          ...
          <div className="absolute bottom-3 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1">
            <svg className="w-5 h-5 text-gray-700 animate-bounce" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
