        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-gray-400">
              ...
              <Link href="/leagues" className="block hover:text-white transition-colors">Alle Ligen &rarr;</Link>
            </div>
          </div>
          ...
          {/* Contact - nur Instagram & Telegram */}
          <div>
            <h3 className="font-bold text-sm uppercase tracking-wider mb-4 text-[var(--gold)]">Kontakt</h3>
            <div className="space-y-3 text-sm">
              <a href="https://instagram.com/T_express247" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-400 hover:text-white transition-colors">
              ...
              <a href="https://t.me/BOT_USERNAME" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-400 hover:text-white transition-colors">
