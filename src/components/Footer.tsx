        ...
        <div className="hidden md:grid grid-cols-3 gap-6 text-center">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3 items-center">
              ...
              <a href="https://t.me/T24Express_bot?start=1" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-gray-400 hover:text-white transition-colors">
        ...
        <div className="md:hidden space-y-6">
          ...
          <div className="text-center">
            ...
            <div className="flex items-center justify-center gap-5">
              ...
              <div className="flex items-center gap-1.5 text-sm text-gray-400">
                <img src="/paypal-logo.png" alt="PayPal" className="h-5 w-5 flex-shrink-0 rounded" />
