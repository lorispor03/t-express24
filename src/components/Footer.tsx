        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:text-center">
          ...
          <div className="col-span-2 md:col-span-1 text-center">
            ...
            <div className="flex flex-col gap-3 items-center">
              ...
              <a href="https://t.me/T24Express_bot" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-sm text-gray-400 hover:text-white transition-colors">
