...
export default function ConsentBanner() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[9999] bg-[#111] border-t border-white/10 px-4 py-4 md:py-3">
      <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center gap-3 sm:gap-4">
        ...
        <button
          ...
          className="flex-shrink-0 bg-[var(--red-main)] hover:bg-[var(--red-dark)] text-white text-sm font-bold px-6 py-2 rounded-lg transition-colors"
        >
          Akzeptieren
        </button>
      </div>
