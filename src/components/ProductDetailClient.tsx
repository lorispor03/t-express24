          ...
          <div className="relative flex items-center">
            ...
            {allImages.length > 1 && (
              <button
                ...
                className="hidden md:flex flex-shrink-0 w-9 h-9 rounded-full bg-white/5 items-center justify-center text-[var(--red-main)] hover:bg-white/10 transition-colors mr-3"
              >
            ...
            <div className="relative bg-[#1a1a1a] rounded-xl overflow-hidden border border-white/5 aspect-square flex-1 min-w-0">
              <img
              ...
              {allImages.length > 1 && (
                <>
                  <button
                    onClick={() => setSelectedImg(prev => prev === 0 ? allImages.length - 1 : prev - 1)}
                    className="md:hidden absolute left-2 top-1/2 -translate-y-1/2 w-8 h-8 rounded-full bg-black/50 flex items-center justify-center text-[var(--red-main)] active:bg-black/70 transition-colors"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={2.5} viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M15 19l-7-7 7-7" />
                    </svg>
                  ...
                  <button
                    ...
                    className="md:hidden absolute right-2 top-1/2 -translate-y-1/2 w-8 h-8 rounded-full bg-black/50 flex items-center justify-center text-[var(--red-main)] active:bg-black/70 transition-colors"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={2.5} viewBox="0 0 24 24">
            ...
            {allImages.length > 1 && (
              <button
                onClick={() => setSelectedImg(prev => prev === allImages.length - 1 ? 0 : prev + 1)}
                className="hidden md:flex flex-shrink-0 w-9 h-9 rounded-full bg-white/5 items-center justify-center text-[var(--red-main)] hover:bg-white/10 transition-colors ml-3"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={2.5} viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
                </svg>
