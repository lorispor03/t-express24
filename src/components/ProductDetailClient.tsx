...
export default function ProductDetailClient({ product, teamId, teamName, leagueName, leagueSlug }: Props) {
    ...
    <div className="max-w-5xl mx-auto px-4 py-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col">
          ...
          <p className="text-2xl font-bold text-[var(--gold)] mb-6">CHF {product.p}</p>
