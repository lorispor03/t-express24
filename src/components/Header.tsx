    ...
    <>
      ...
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-gray-200">
        <div className="max-w-[1920px] mx-auto px-4 md:px-8 xl:px-12 2xl:px-16 h-12 md:h-16 flex items-center justify-between relative">
          ...
          {/* Chat Button Mobile - between logo and icons */}
          <button
            onClick={() => window.dispatchEvent(new Event('open-chat'))}
            className="md:hidden ml-2 w-7 h-7 rounded-full flex items-center justify-center hover:scale-110 transition-transform animate-chat-pulse"
            style={{ background: 'linear-gradient(135deg, var(--red-main), var(--red-dark))' }}
            title="Kundensupport"
          >
