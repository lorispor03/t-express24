        ...
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-7 text-sm font-medium">
            ...
            <div className="flex items-center gap-4 ml-2 pl-4 border-l border-white/10">
              <button onClick={() => setSearchOpen(true)} className="hover:text-[var(--gold)] transition-colors" title="Suche">
          ...
          <div className="flex items-center gap-3 md:hidden">
            <button onClick={() => setSearchOpen(true)} className="text-gray-400 hover:text-[var(--gold)]" title="Suche">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
              </svg>
            </button>
